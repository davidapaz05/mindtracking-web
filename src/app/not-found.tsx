...
export default function NotFound() {
  ...
  if (loading) {
    return (
      <div
        className="relative flex items-center justify-center h-screen bg-cover bg-center text-white px-6 md:px-12 lg:px-16 py-8"
  ...
  const cta = isAuthenticated
    ? { href: "/dashboard", label: "Acessar meu DashBoard" }
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mb-4 sm:mb-6 md:mb-6 lg:mb-12">
        <Image
          src="/images/M9_33.svg"
          alt="Athena ilustrada"
          width={300}
          height={300}
